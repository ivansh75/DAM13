...
public class Cliente {
    ...
    private static String fichero;// = "C:\\Users\\i\\Documents\\NetBeansProjects\\swing\\Prueba.txt";
    private static String ficheroErrores;// = "C:\\Users\\i\\Documents\\NetBeansProjects\\swing\\PruebaErrores.txt";
    ...
    /*
       public static void main(String[] args) {
        ...
        Cliente rn = new Cliente();
        try {
            rn.run("localhost",8888, fichero, ficheroErrores);
